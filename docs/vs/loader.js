...
if (window.location.href.indexOf("ide-runtime") > -1) {
    ...
    function(e) {
        var t = function(e, t, r) { this.type = e, this.detail = t, this.timestamp = r };
        e.LoaderEvent = t;
        var r = function() {
    ...
    function(e) {
        ...
        var r = function() {
            ...
            return r.validateConfigurationOptions = function(r) {
                if ("string" != typeof(r = r || {}).baseUrl && (r.baseUrl = ""), "boolean" != typeof r.isBuild && (r.isBuild = !1), "object" != typeof r.paths && (r.paths = {}), "object" != typeof r.config && (r.config = {}), void 0 === r.catchError && (r.catchError = !1), void 0 === r.recordStats && (r.recordStats = !1),
        ...
        var n = function() {
            ...
            return t.prototype._createIgnoreDuplicateModulesMap = function() { this.ignoreDuplicateModulesMap = {}; for (var e = 0; e < this.options.ignoreDuplicateModules.length; e++) this.ignoreDuplicateModulesMap[this.options.ignoreDuplicateModules[e]] = !0 }, t.prototype._createNodeModulesMap = function() {
                    ...
                    })), this.sortedPathsRules.sort((function(e, t) { return t.from.length - e.from.length }))
                    ...
                    for (var r, n = 0, o = this.sortedPathsRules.length; n < o; n++)
                        if (r = this.sortedPathsRules[n], e.Utilities.startsWith(t, r.from)) { for (var i = [], s = 0, a = r.to.length; s < a; s++) i.push(r.to[s] + t.substr(r.from.length)); return i }
                    return [t]
                ...
                t.prototype.getConfigForModule = function(e) { if (this.options.config) return this.options.config[e] }, t.prototype.shouldCatchError = function() { return this.options.catchError }, t.prototype.shouldRecordStats = function() { return this.options.recordStats }, t.prototype.onError = function(e) { this.options.onError(e) }, t
        }();
        e.Configuration = n
    }(AMDLoader || (AMDLoader = {})),
    function(e) {
        var t = function() {
                ...
                return e.prototype.load = function(e, t, i, s) {
                    ...
                    this._callbackMap.hasOwnProperty(t) ? this._callbackMap[t].push(u) : (this._callbackMap[t] = [u], this._scriptLoader.load(e, t, (function() { return a.triggerCallback(t) }), (function(e) {
            ...
            r = function() {
                ...
                return t.prototype.attachListeners = function(e, t, r) {
                    var n = function() { e.removeEventListener("load", o), e.removeEventListener("error", i) },
                        o = function(e) { n(), t() },
                        i = function(e) { n(), r(e) };
                    ...
                    if (/^node\|/.test(r)) {
                        var i = t.getConfig().getOptionsLiteral().nodeRequire || e.global.nodeRequire,
                            s = r.split("|"),
                            a = null;
                        try { a = i(s[1]) } catch (e) { return void o(e) }
                        t.enqueueDefineAnonymousModule([], (function() { return a })), n()
                    } else {
            ...
            n = function() {
                function e() {}
                return e.prototype.load = function(e, t, r, n) { try { importScripts(t), r() } catch (e) { n(e) } }, e
            }(),
            o = function() {
                ...
                return t.prototype._init = function(e) { this._didInitialize || (this._didInitialize = !0, this._fs = e("fs"), this._vm = e("vm"), this._path = e("path"), this._crypto = e("crypto")) }, t.prototype._initNodeRequire = function(e, t) {
                    ...
                    if (r && !this._didPatchNodeRequire) {
                        ...
                        o.prototype._compile = function(e, i) {
                            ...
                            } catch (e) { d.record(61, u) }
                            var h = new n._vm.Script(a, l),
                                f = h.runInThisContext(l),
                                p = n._path.dirname(i),
                                _ = function(e) {
                                    var t = e.constructor,
                                        r = function(t) { try { return e.require(t) } finally {} };
                    ...
                    var s = this,
                        ...
                        u = a.nodeInstrumenter || function(e) { return e };
                    this._init(d), this._initNodeRequire(d, r);
                    var l = r.getRecorder();
                    if (/^node\|/.test(n)) {
                        var c = n.split("|"),
                            h = null;
                        try { h = d(c[1]) } catch (e) { return void i(e) }
                    ...
                    var i = this;
                    e.cachedDataRejected ? this._fs.unlink(r, (function(n) { o.getRecorder().record(62, r), i._createAndWriteCachedData(e, t, r, o), n && o.getConfig().onError(n) })) : n && this._createAndWriteCachedData(e, t, r, o)
                    ...
                    if (t) {
                        var o = void 0,
                            ...
                            s = void 0,
                            a = 2,
                            d = function(e) { e ? n(e) : 0 == --a && n(void 0, o, i, s) };
                        this._fs.readFile(e, { encoding: "utf8" }, (function(e, t) { o = t, d(e) })), this._fs.readFile(t, (function(e, n) {!e && n && n.length > 0 ? (s = n.slice(0, 16), i = n.slice(16), r.record(60, t)) : r.record(61, t), d() }))
                    ...
                    n && (e.cachedDataRejected || setTimeout((function() {
                        ...
                        n.equals(e) || (o.getConfig().onError(new Error("FAILED TO VERIFY CACHED DATA, deleting stale '" + r + "' now, but a RESTART IS REQUIRED")), i._fs.unlink(r, (function(e) { e && o.getConfig().onError(e) })))
    ...
    function(e) {
        ...
        var r = function() {
            ...
            }, t.prototype.isComplete = function() { return this._isComplete }, t
        }();
        e.Module = r;
        var n = function() {
                ...
                return e.prototype.getMaxModuleId = function() { return this._nextId }, e.prototype.getModuleId = function(e) { var t = this._strModuleIdToIntModuleId.get(e); return void 0 === t && (t = this._nextId++, this._strModuleIdToIntModuleId.set(e, t), this._intModuleIdToStrModuleId[t] = e), t }, e.prototype.getStrModuleId = function(e) { return this._intModuleIdToStrModuleId[e] }, e
            }(),
            o = function() {
        ...
        var s = function() {
            function s(t, r, o, i, s) {
                void 0 === s && (s = 0), this._env = t, this._scriptLoader = r,
            ...
            return s.prototype.reset = function() { return new s(this._env, this._scriptLoader, this._defineFunc, this._requireFunc, this._loaderAvailableTimestamp) }, s.prototype.getGlobalAMDDefineFunc = function() { return this._defineFunc }, s.prototype.getGlobalAMDRequireFunc = function() { return this._requireFunc }, s._findRelevantLocationInStack = function(e, t) {
                    for (var r = function(e) { return e.replace(/\\/g, "/") }, n = r(e), o = t.split(/\n/), i = 0; i < o.length; i++) {
                        var s = o[i].match(/(.*):(\d+):(\d+)\)?$/);
                        if (s) {
                            var a = s[1],
                                d = s[2],
                    ...
                    if (this._modules2[u]) this._config.isDuplicateMessageIgnoredFor(e) || console.warn("Duplicate definition of module '" + e + "'");
                        ...
                        this._modules2[u] = l, this._config.isBuild() && (this._buildInfoDefineStack[u] = s, this._buildInfoDependencies[u] = (l.dependencies || []).map((function(e) { return d._moduleIdProvider.getStrModuleId(e.id) }))), this._resolve(l)
                    }
                ...
                }, s.prototype._normalizeDependencies = function(e, t) { for (var r = [], n = 0, o = 0, i = e.length; o < i; o++) r[n++] = this._normalizeDependency(e[o], t); return r }, s.prototype._relativeRequire = function(t, r, n, o) {
                    ...
                    if (o)
                        for (var i = 0, s = o.length; i < s; i++) { var a = this._findCyclePath(o[i].id, t, r + 1); if (null !== a) return a.push(e), a }
                    return null
                    ...
                    return n.toUrl = function(e) { return r._config.requireToUrl(t.resolveModule(e)) }, n.getStats = function() { return r.getLoaderEvents() }, n.config = function(e, t) { void 0 === t && (t = !1), r.configure(e, t) }, n.__$__nodeRequire = e.global.nodeRequire, n
                        ...
                        var o = -1,
                            i = function(r) {
                                if (++o >= n.length) t._onLoadError(e, r);
                                    ...
                                    a.record(10, s), t._scriptLoader.load(t, s, (function() { t._config.isBuild() && (t._buildInfoPath[e] = s), a.record(11, s), t._onLoad(e) }), (function(e) { a.record(12, s), i(e) }))
                                }
                            };
                        i(null)
                    }
                ...
                s.prototype._loadPluginDependency = function(e, r) {
                                ...
                                if (a !== o.MODULE)
                                    if (a !== o.REQUIRE) {
                                        ...
                                        if (d && d.isComplete()) {
                                            ...
                                            if (l && l.isComplete()) { this._loadPluginDependency(l.exports, a); continue }
                    ...
                    if (!e.isComplete()) {
                        ...
                        if (f) { this._inversePluginDependencies2.delete(e.id); for (s = 0, a = f.length; s < a; s++) this._loadPluginDependency(e.exports, f[s]) }
                    }
                }, s
        }();
        e.ModuleManager = s
